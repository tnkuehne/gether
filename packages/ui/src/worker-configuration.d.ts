/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: ff3cc3cbebdc09d7ce85b76fe2d78e12)
// Runtime types generated with workerd@1.20251210.0 2025-12-13 nodejs_als
declare namespace Cloudflare {
	interface Env {
		COLLAB_DOCUMENT: DurableObjectNamespace /* CollaborativeDocument from collab */;
		ASSETS: Fetcher;
	}
}
